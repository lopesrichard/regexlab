...
<body>
  <div class="container">
    <h1 class="main-title">Regex Number Range</h1>
    <p class="have-fun">Just type and have fun<p>
    <form>
        <div class="form-group">
            <label class="label" for="from">From: </label>
            <input id="from" class="form-control input" name="from" type="number">
        </div>
        <div class="form-group">
            <label class="label" for="to">To: </label>
            <input id="to" class="form-control input" name="to" type="number">
        </div>
        <div class="form-group">
